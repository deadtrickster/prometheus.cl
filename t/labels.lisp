...
(subtest "Labels"
  (subtest "Label name"
    ...
    (subtest "Validated on metric creation"
      (is-error-report (make-instance 'prom::metric-family :name "qwe" :labels #("qwe")) prom:invalid-labels-error "Invalid labels. Got #(\"qwe\") (type: (SIMPLE-VECTOR 1)), expected LIST")
  ...
  (subtest "Label values"
    ...
    (subtest "Validates on get-metric"
      (let ((mf (make-instance 'prom::metric-family :name "qwe" :labels '("qwe"))))
        (is-error-report (prom:get-metric mf #("qwe")) prom:invalid-labels-error "Invalid labels. Got #(\"qwe\") (type: (SIMPLE-VECTOR 1)), expected LIST")
