...
(subtest "Metrics"
  (subtest "Metric name"
    ...
    (subtest "Check metric help"
      (is-error-report (prom::check-metric-help nil) prom:invalid-metric-help-error "Metric help NIL is invalid. Reason: metric help is not a string"))
